...
export class ClassService {
  ...
  public async createClass(data: IClass): Promise<ServiceResponse> {
    ...
    return { success: true, message: Messages.CLASS_CREATED_SUCCESS, data: created };
  }

  public async getAllClasses(organizationId: string): Promise<ServiceResponse> {
    const data = await this.classRepository.findByOrganizationId(organizationId);
  ...
  public async updateClass(id: string, payload: Partial<IClass>): Promise<ServiceResponse> {
    ...
    return { success: true, message: Messages.CLASS_UPDATED_SUCCESS, data: updated };
  }
  ...
  public async deleteClass(id: string): Promise<ServiceResponse> {
    ...
    return { success: true, message: Messages.CLASS_DELETED_SUCCESS, data: deleted };
  }
}
